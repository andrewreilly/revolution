...
/**
 * A <code>Panel</code> that positions components horizontally.
 *
...
public class HorizontalPanel extends Panel
{
     ...
     */
    public HorizontalPanel(Layouts xLayout, Layouts yLayout)
    {
        createLayout(new LineLayout(xLayout, yLayout));
    }
